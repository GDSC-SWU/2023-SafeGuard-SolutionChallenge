...
import 'package:safeguard/file_list/file_five.dart';
import 'package:safeguard/file_list/file_four.dart';
...
class FileThreeHome extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      Container(
        ...
        child: SizedBox(
          ...
          child: TextButton(
            ...
            onPressed: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (_) => (FileFour())));
            },
            child: const Text('화기작업 허가서'),
          ),
        ),
      ),
      Container(
        ...
        child: SizedBox(
          ...
          child: TextButton(
            ...
            onPressed: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (_) => (FileFive())));
            },
            child: const Text('일반위험작업 허가서'),
          ),
        ),
      ),
    ]));
